...
output_dir = fullfile(analysis_dir, 'outputs', ['glm2_mf_frequ_' current_date]);
...
connames = {
    'first_stim', 'first_stimxFrequ', ...
    'second_stim', 'second_stimxFrequ', ...
...
for s = 1:length(subjects)
    ...
    for r = 1:2 % Only learning runs
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(1).pmod(1).name = 'Frequ';
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(1).pmod(1).param = zscore(block_data.first_stim_frequ);
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(1).name = 'Frequ';
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(1).param = zscore(block_data.second_stim_frequ);
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).pmod(1).name = 'Frequ';
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).pmod(1).param = zscore(block_data.first_stim_frequ);
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(1).name = 'Frequ';
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(1).param = zscore(block_data.second_stim_frequ);
