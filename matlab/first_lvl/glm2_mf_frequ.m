...
output_dir = fullfile(analysis_dir, 'outputs', ['glm2_mf_chosenfrequ_' current_date]);
...
connames = {
    'first_stim', ...
    'second_stim', 'second_stimxChosenFrequ', ...
...
for s = 1:length(subjects)
    ...
    for r = 1:3 % all runs (learning1, learning2, test)
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(1).name = 'ChosenFrequ';
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(1).param = block_resp.chosen_stim_frequ;
