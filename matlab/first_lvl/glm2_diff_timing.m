...
output_dir = fullfile(analysis_dir, 'outputs', ['glm2_diff_timing_scrubbed_' current_date]);
...
for s = 1:length(subjects)
    ...
    for r = 1:2 % Only learning runs
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(1).param = block_data.first_stim_value_rl_zscore;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(2).param = block_data.first_stim_value_ck_zscore;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(3).param = block_data.second_stim_value_rl_zscore;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(4).param = block_data.second_stim_value_ck_zscore;
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(1).name = 'Qval1';
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(1).param = block_data.first_stim_value_rl_zscore;
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(1).poly = 1;
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(2).name = 'Hval1';
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(2).param = block_data.first_stim_value_ck_zscore;
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(2).poly = 1;
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(3).name = 'Qval2';
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(3).param = block_data.second_stim_value_rl_zscore;
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(3).poly = 1;
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(4).name = 'Hval2';
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(4).param = block_data.second_stim_value_ck_zscore;
