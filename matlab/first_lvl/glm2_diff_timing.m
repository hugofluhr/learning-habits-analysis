...
output_dir = fullfile(analysis_dir, 'outputs', ['glm2_diff_timing_' current_date]);
...
for s = 1:length(subjects)
    ...
    for r = 1:2 % Only learning runs
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(1).param = zscore(block_data.first_stim_value_rl);
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(2).param = zscore(block_data.first_stim_value_ck);
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(3).param = zscore(block_data.second_stim_value_rl);
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).pmod(4).param = zscore(block_data.second_stim_value_ck);
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(1).param = zscore(block_data.first_stim_value_rl);
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(2).param = zscore(block_data.first_stim_value_ck);
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(3).param = zscore(block_data.second_stim_value_rl);
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(4).param = zscore(block_data.second_stim_value_ck);
