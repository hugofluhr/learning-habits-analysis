...
output_dir = fullfile(analysis_dir, 'outputs', ['glm2_combined_long_pmod' current_date]);
...
for s = 1:length(subjects)
    ...
    for r = 1:2 % Only learning runs
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(1).duration = block_data.t_second_stim - block_data.t_action; % check duration
