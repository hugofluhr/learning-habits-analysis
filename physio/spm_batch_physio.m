matlabbatch{1}.spm.tools.physio.save_dir = {'/Users/hugofluhr/phd_local/data/LearningHabits/data-samples/mri/derivatives/physio/sub-01/ses-1/func'};
matlabbatch{1}.spm.tools.physio.log_files.vendor = 'Philips';
matlabbatch{1}.spm.tools.physio.log_files.cardiac = {'/Users/hugofluhr/phd_local/data/LearningHabits/data-samples/mri/sub-01/ses-1/func/sub-01_ses-1_task-learning_run-1_physio.log'};
matlabbatch{1}.spm.tools.physio.log_files.respiration = {'/Users/hugofluhr/phd_local/data/LearningHabits/data-samples/mri/sub-01/ses-1/func/sub-01_ses-1_task-learning_run-1_physio.log'};
...
matlabbatch{1}.spm.tools.physio.scan_timing.sqpar.TR = 2.33384;
matlabbatch{1}.spm.tools.physio.scan_timing.sqpar.Ndummies = 5;
matlabbatch{1}.spm.tools.physio.scan_timing.sqpar.Nscans = 426;
...
matlabbatch{1}.spm.tools.physio.scan_timing.sync.gradient_log.zero = 0.5;
matlabbatch{1}.spm.tools.physio.scan_timing.sync.gradient_log.slice = 0.6;
